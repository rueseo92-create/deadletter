                ...
                <div className="p-6 lg:p-7">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-lg bg-slate-50 border border-slate-100 p-3">
                      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">직접 하기</p>
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
            {[
              ...
              { num: "Daily", label: "콘텐츠 발행", icon: "schedule" },
              { num: `${siteConfig.categories.length}`, label: "전문 카테고리", icon: "category" },
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
              ...
              <div key={item.step} className="group rounded-2xl border border-slate-200/80 overflow-hidden hover:shadow-lg transition-all duration-300">
                <div className="p-6 pt-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-[10px] font-bold text-slate-400 tracking-wider">STEP {item.step}</span>
                  </div>
          ...
          <div className="mt-12 grid sm:grid-cols-3 gap-4">
            {[
              { icon: "timer", title: "소요 기간", desc: "간단한 블로그 세팅은 1~2주, 풀 세팅은 2~4주 정도 걸려요." },
              { icon: "sync", title: "수정 & 피드백", desc: "작업 중 피드백 반영은 무제한이에요. 만족하실 때까지 조정합니다." },
              { icon: "support_agent", title: "사후 지원", desc: "인수인계 후 1개월간 무료 지원. 이후에도 유지보수 계약이 가능해요." },
            ].map((item) => (
